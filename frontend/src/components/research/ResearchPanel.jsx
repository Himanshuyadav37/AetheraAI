...
function ResearchPanel({ result }) {
  ...
  function downloadReportAsPdf(e) {
    ...
    printWindow.document.write(`
      ...
      <html>
        <head>
          <title>${reportTitle} - Aethera Research Dossier</title>
          <meta charset="utf-8" />
          <style>
        ...
        <body>
          <div class="pdf-header">
            <span class="pdf-badge">Aethera Autonomous Research Dossier</span>
          ...
          <div class="pdf-footer">
            <span>Generated by Aethera Autonomous Intelligence Engine</span>
            <span>Aethera Research AI</span>
          </div>
          <script>
