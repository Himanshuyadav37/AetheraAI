        ...
        if (response_msg and response_msg.tool_calls) or (is_explicit_email and not is_confirming_email) or is_confirming_email:
            ...
            assistant_content = run_agent_with_tools(
                ...
                system_instruction=(
                    ...
                    "- Aethera (Aethera AI) is an autonomous AI platform for turning ideas into production-ready software and intelligent workflows with the tagline: 'Intelligence beyond boundaries.', designed and engineered by the Aethera AI Engineering Team.\n"
                    "- The engineering team specializes in autonomous multi-agent operating systems, scalable backend architectures, and modern reactive web platforms.\n"
                    ...
                    "  - Answer politely and clearly that you are **Aethera AI** (*'Intelligence beyond boundaries.'*), engineered by the **Aethera AI Engineering Team**.\n"
                    "  - Do not mention any individual's personal name or external personal portfolio / social links.\n\n"
